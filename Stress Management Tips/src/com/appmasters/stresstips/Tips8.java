...
public class Tips8 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public void onClick(View v) {
        	Intent intent = new Intent(getApplicationContext(), Tips9.class);
        ...
        public void onClick(View v) {
       		...
       		params.putString("picture", "https://www.facebook.com/TheStressManagement/photos/a.933982080018493.1073741827.121505604599482/933982636685104/?type=3&theater");
        		...
        		fb.dialog(Tips8.this, "feed", params, new DialogListener() {

    				@Override
    				public void onComplete(Bundle values) {
    					
    					Toast.makeText(Tips8.this, "Successfully Shared in Facebook", Toast.LENGTH_LONG).show();
